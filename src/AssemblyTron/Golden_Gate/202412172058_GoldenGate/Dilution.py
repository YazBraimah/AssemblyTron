...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.aspirate(volume = 119.0, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(119.0, tuberack2['B3'], rate=1.0) 
    right_pipette.aspirate(volume = 99.0, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(99.0, tuberack2['B4'], rate=1.0) 
    right_pipette.aspirate(volume = 79.0, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(79.0, tuberack2['B5'], rate=1.0) 
    right_pipette.aspirate(volume = 159.0, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(159.0, tuberack2['B6'], rate=1.0) 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.0, cold_tuberack['B3'], rate=1.0) 
    left_pipette.dispense(1.0, tuberack2['B3'], rate=1.0) 
    left_pipette.mix(3,5,tuberack2['B3']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.0, cold_tuberack['B4'], rate=1.0) 
    left_pipette.dispense(1.0, tuberack2['B4'], rate=1.0) 
    ...
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.0, cold_tuberack['A1'], rate=1.0) 
    left_pipette.dispense(1.0, tuberack2['A1'], rate=1.0) 
    left_pipette.mix(3,5,tuberack2['A1']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.0, cold_tuberack['A2'], rate=1.0) 
    left_pipette.dispense(1.0, tuberack2['A2'], rate=1.0) 
    left_pipette.mix(3,5,tuberack2['A2']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.0, cold_tuberack['A3'], rate=1.0) 
    left_pipette.dispense(1.0, tuberack2['A3'], rate=1.0) 
    left_pipette.mix(3,5,tuberack2['A3']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.0, cold_tuberack['A4'], rate=1.0) 
    left_pipette.dispense(1.0, tuberack2['A4'], rate=1.0) 
    left_pipette.mix(3,5,tuberack2['A4']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.0, cold_tuberack['A5'], rate=1.0) 
    left_pipette.dispense(1.0, tuberack2['A5'], rate=1.0) 
    left_pipette.mix(3,5,tuberack2['A5']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.0, cold_tuberack['A6'], rate=1.0) 
    left_pipette.dispense(1.0, tuberack2['A6'], rate=1.0) 
    left_pipette.mix(3,5,tuberack2['A6']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.0, cold_tuberack['B1'], rate=1.0) 
    left_pipette.dispense(1.0, tuberack2['B1'], rate=1.0) 
    left_pipette.mix(3,5,tuberack2['B1']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(1.0, cold_tuberack['B2'], rate=1.0) 
    left_pipette.dispense(1.0, tuberack2['B2'], rate=1.0) 
    left_pipette.mix(3,5,tuberack2['B2']) 
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,119.0,tuberack2['B3']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,99.0,tuberack2['B4']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,79.0,tuberack2['B5']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,159.0,tuberack2['B6']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
