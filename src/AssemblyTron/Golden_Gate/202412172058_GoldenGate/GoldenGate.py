...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    protocol.pause('move to gradient thermocycler. set gradiet to be between 56.8134423336132 and 70.61121645449582. Extension time should be 128.73000000000002 seconds. Follow normal parameters for everything else. A1 is cool, A8 is hot.') 
    temp_module.set_temperature(4) 
    tc_mod.set_block_temperature(4) 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(18.0, watertuberack['A1'], rate=2.0) 
    right_pipette.dispense(18.0, pcrplate['A6'], rate=2.0) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(18.0, watertuberack['A1'], rate=2.0) 
    right_pipette.dispense(18.0, pcrplate['B6'], rate=2.0) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(18.0, watertuberack['A1'], rate=2.0) 
    right_pipette.dispense(18.0, pcrplate['A5'], rate=2.0) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.aspirate(18.0, watertuberack['A1'], rate=2.0) 
    right_pipette.dispense(18.0, pcrplate['B5'], rate=2.0) 
    right_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(5.0, cold_tuberack['D4'], rate=2.0) 
    left_pipette.dispense(5.0, pcrplate['A6'], rate=2.0) 
    left_pipette.mix(3,10,pcrplate['A6']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(5.0, cold_tuberack['D4'], rate=2.0) 
    left_pipette.dispense(5.0, pcrplate['B6'], rate=2.0) 
    left_pipette.mix(3,10,pcrplate['B6']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(5.0, cold_tuberack['D4'], rate=2.0) 
    left_pipette.dispense(5.0, pcrplate['A5'], rate=2.0) 
    left_pipette.mix(3,10,pcrplate['A5']) 
    left_pipette.drop_tip() 
    left_pipette.pick_up_tip() 
    left_pipette.aspirate(5.0, cold_tuberack['D4'], rate=2.0) 
    left_pipette.dispense(5.0, pcrplate['B5'], rate=2.0) 
