...
def run(protocol: protocol_api.ProtocolContext): 
    ...
    right_pipette.aspirate(volume = 139.0, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(139.0, tuberack2['B4'], rate=1.0) 
    right_pipette.aspirate(volume = 159.0, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(159.0, tuberack2['B5'], rate=1.0) 
    right_pipette.aspirate(volume = 459.0, location = watertuberack['A1'], rate=1.0) 
    right_pipette.dispense(459.0, tuberack2['B6'], rate=1.0) 
    ...
    left_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,139.0,tuberack2['B4']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,159.0,tuberack2['B5']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
    right_pipette.mix(3,459.0,tuberack2['B6']) 
    right_pipette.drop_tip() 
    right_pipette.pick_up_tip() 
