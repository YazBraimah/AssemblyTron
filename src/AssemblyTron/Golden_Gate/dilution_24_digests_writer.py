...
def write_dilution():
    ...
    def main():
        ...
        f.write(
            ...
            "    cold_tuberack = temp_module.load_labware('opentrons_24_aluminumblock_generic_1.5ml_screwcap', label='Temperature-Controlled Tubes') \r\n"
            "    temp_module.set_temperature(4) \r\n"
            "    tc_mod.open_lid() \r\n"

            "    right_pipette = protocol.load_instrument('p300_single_gen2','right',tip_racks=[tiprack1]) \r\n"
            "    left_pipette = protocol.load_instrument('p20_single_gen2','left',tip_racks = [tiprack3]) \r\n"       
        )
